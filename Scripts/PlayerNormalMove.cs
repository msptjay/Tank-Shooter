...
public partial class PlayerNormalMove : CharacterBody3D
{
...
public override void _Ready()
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		if(Input.IsActionPressed("Move_Forward") && _CurrentAttackState != AttackState.Shooting || Input.IsActionPressed("Move_Backward"))
		{
			HandleForward();
